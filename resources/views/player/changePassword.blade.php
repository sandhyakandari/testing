...
@section('content')
    ...
    <!-- player-change-password-section-start -->
    <section class="patient-dashboard bg-color-3 player-dashboard-section player-change-password">
                    ...
                    <div class="add-listing change-password custom-change-password">
                        <div class="single-box">
                            ...
                            <div class="inner-box">
                                ...
                                <form action="{{ route('player.storeChangePassword') }}" method="post"
    ...
    <!-- player-change-password-section-end -->
@endsection
