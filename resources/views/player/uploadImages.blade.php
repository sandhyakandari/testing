...
@section('content')
    ...
    <!-- player-upload-images-section-start -->
    <section class="doctors-dashboard bg-color-3 player-upload-img-section">
                ...
                <div class="outer-container">
                    <div class="add-listing my-profile">
                        <div class="single-box">
                            <div class="title-box">
                                <h3>Upload Your Achivement Photograph</h3>
                            </div>
                            <div class="inner-box">
                                <div class="profile-title">
                                    <figure class="image-box">
                                        <img src="{{ $player_img }}" alt="{{ $name }}">
                                    </figure>
                                    <div class="upload-photo">
                                        <form action="{{ route('player.playerUploadImagesStore') }}" method="POST"
                                            enctype="multipart/form-data" name="uploadImages">
                                            @csrf
                                            <div class="form-group">
                                                <input type="file" name="image" id="image" class="form-control-fil"
                                                    accept="image/png, image/jpeg, image/jpg">
                                                <span>Allowed JPG, JPEG, and PNG.</span>
                                                <p class="error" id="imageError"></p>
                                            </div>
                                            <div class="form-group caption-input">
    ...
    <!-- player-upload-images-section-end -->
@endsection
